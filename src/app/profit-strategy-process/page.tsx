            ...
            <div className="space-y-10">
              <div>
                ...
                <p className="text-zinc-400 mt-4">
                  For all profit-related strategy packages, we also require access to the following financial and operational metrics:
                </p>
                <ul className="list-disc list-inside text-zinc-400 mt-2 space-y-1">
                  ...
                  <li>Return Rate</li>
                  <li>Fulfilment Costs (% of revenue)</li>
                  <li>Platform Fees (% of revenue)</li>
                  <li>Stockholding Value or Turnover Data</li>
