      ...
      <MainLayout>
        ...
        >
          ...
          <div className="bg-white border border-zinc-300 rounded-xl p-5 sm:p-6">
            ...
            <div className="space-y-5 text-sm sm:text-base leading-relaxed">
              <div className="border-l-4 border-black pl-4">
                <p className="text-black font-semibold mb-1">Audience Segmentation & Value Targeting</p>
                <p className="text-zinc-700">Understand your ideal customer by behaviour, spend, and LTV potential.</p>
              </div>

              <div className="border-l-4 border-black pl-4">
                <p className="text-black font-semibold mb-1">Market & Competitor Landscape</p>
                <p className="text-zinc-700">Identify your biggest opportunities and how to position for growth.</p>
              </div>

              <div className="border-l-4 border-black pl-4">
                <p className="text-black font-semibold mb-1">Full Go-to-Market Strategy (Shopify Focus)</p>
                <p className="text-zinc-700">Acquisition, conversion, retention – mapped from day one.</p>
              </div>

              <div className="border-l-4 border-black pl-4">
                <p className="text-black font-semibold mb-1">Multi-Channel CAC Targeting & GA4 Setup</p>
                <p className="text-zinc-700">Aggressive but achievable CAC goals, tracked in real time.</p>
              </div>

              <div className="border-l-4 border-black pl-4">
                <p className="text-black font-semibold mb-1">Conversion Rate Optimisation (CRO)</p>
                <p className="text-zinc-700">Funnel-wide tactics to turn traffic into profit.</p>
              </div>

              <div className="border-l-4 border-black pl-4">
                <p className="text-black font-semibold mb-1">Early Loyalty & Retention Framework</p>
                <p className="text-zinc-700">Drive repeat purchases and build habits from first order.</p>
              </div>

              <div className="border-l-4 border-black pl-4">
                <p className="text-black font-semibold mb-1">Investor-Grade Forecasts & KPIs</p>
                <p className="text-zinc-700">Build trust with credible projections and proof of scalability.</p>
              </div>

              <div className="border-l-4 border-black pl-4">
                <p className="text-black font-semibold mb-1">Ongoing Strategy Support</p>
                <p className="text-zinc-700">Implementation guidance and strategic direction through launch.</p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4 text-sm sm:text-base leading-relaxed text-zinc-600">
            <p>
              Ideal for <strong>new eCommerce brands</strong> looking to launch profit-first, <strong>founders raising capital</strong>, or <strong>product teams</strong> debuting new ranges. Built specifically for <span className="text-black">Shopify</span> and <span className="text-black">GA4</span>.
            </p>
